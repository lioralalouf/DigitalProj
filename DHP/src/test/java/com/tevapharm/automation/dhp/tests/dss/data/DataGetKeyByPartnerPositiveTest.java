...
public class DataGetKeyByPartnerPositiveTest extends PartnerApiTestBase {
    ...
    @Test(priority = 1, testName = "Generate six API keys by the partner and getting the API key details, Expecting that after six API keys, the first one will be revoked")
