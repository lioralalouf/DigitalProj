...
import com.tevapharm.attte.models.request.questionnaire.DailySelfAssessmentDto;
...
public class GetUserDsaByPartnerPositiveTest extends PartnerApiTestBase {
    ...
    public void tc01_getDsa() throws IOException, ParseException, InterruptedException, org.json.simple.parser.ParseException {
    ...
    @Traceability(FS = {"1657"})
    public void tc02_getDsaAfterUpdateData() throws IOException, ParseException, InterruptedException, org.json.simple.parser.ParseException {
        ExtentTest extentTest = ExtentManager.getTest(this.getClass());
        String patientID = UUID.randomUUID().toString();
