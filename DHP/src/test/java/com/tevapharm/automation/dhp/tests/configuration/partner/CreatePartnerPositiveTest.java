...
public class CreatePartnerPositiveTest extends PartnerApiTestBase {
    ...
    @Test(priority = 1, testName = "Onboard a new partner with 'period'", dataProvider = "getPeriodTrue", dataProviderClass = DataProviders.class)
    ...
    @Test(priority = 2, testName = "Get the onboarded partner details")
    @Traceability(FS = {"1599", "1604"})
