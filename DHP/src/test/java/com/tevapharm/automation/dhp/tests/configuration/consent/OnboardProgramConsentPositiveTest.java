...
public class OnboardProgramConsentPositiveTest extends PartnerApiTestBase {
    ...
    public void tc01_checkAccessTokenCreated() throws IOException {
        ...
        Response responseFile = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardPn01ConsentUrl_program"))
                .then()
                .log().all()
                .extract().response();
        ...
        Response responseFileC = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardHipaa01ConsentUrl_program"))
                .then()
                .log().all()
                .extract().response();
        ...
        Response responseFileD = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardMarketing02ConsentUrl_program"))
                .then()
                .log().all()
                .extract().response();
        ...
        Response responseFileE = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardSignature02ConsentUrl_program"))
                .then()
                .log().all()
                .extract().response();
        ...
        Response responseFileF = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardPac02ConsentUrl_program"))
                .then()
                .log().all()
                .extract().response();
        ...
        TevaAssert.assertEquals(extentTest, consentsResponse.consents.get(0).version, "1.0", "Version 1.0 documents are displayed");
        TevaAssert.assertEquals(extentTest, consentsResponse.consents.get(1).version, "2.0", "Version 2.0 documents are displayed");
    ...
    public void tc02_UpdateDocuments() throws IOException {
        ...
        //upload signature and conditions for the program
        extentTest.info("Onboard signature policy document in different version 'Version 1.0'");
        File signatureTxt = new File("./documents/signature.txt");
        Response responseFileE = given()
                .filter(new ConsoleReportFilter(extentTest))
                .baseUri(PropertyUtils.readProperty("adminUrl"))
                ...
                .multiPart("file", signatureTxt, "text/plain")
                .log().all()
                .post(PropertyUtils.readProperty("onboardSignature01ConsentUrl_program"))
                .then()
                .log().all()
                .extract().response();
        ...
        extentTest.info("Verify all versions are displayed, all locales and every document is displayed in the correct version and locale");
        extentTest.info("Verify that updated signature document version 1.0 and version 2.0 are displayed");
        TevaAssert.assertEquals(extentTest, consentsResponse.consents.get(0).version, "1.0", "Version 1.0 documents are displayed");
        TevaAssert.assertEquals(extentTest, consentsResponse.consents.get(1).version, "2.0", "Version 2.0 documents are displayed");
        TevaAssert.assertEquals(extentTest, consentsResponse.consents.get(0).locales.get(0).locale, "en-US", "en-US documents are displayed");
        TevaAssert.assertEquals(extentTest, consentsResponse.consents.get(1).locales.get(0).locale, "es-US", "es-US documents are displayed");
