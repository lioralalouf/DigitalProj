...
public class OnboardOrganizationConsentPositiveTest extends PartnerApiTestBase {
    ...
    public void tc01_checkAccessTokenCreated() throws IOException {
        ...
        Response responseFileB = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardtou01ConsentUrl_organization"))
                .then()
                .log().all()
                .extract().response();
        ...
        Response responseFileC = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardHipaa01ConsentUrl_organization"))
                .then()
                .log().all()
                .extract().response();
        ...
        Response responseFileD = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardMarketing02ConsentUrl_organization"))
                .then()
                .log().all()
                .extract().response();
        ...
        Response responseFileE = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardSignature02ConsentUrl_organization"))
                .then()
                .log().all()
                .extract().response();
        ...
        Response responseFileF = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardPac02ConsentUrl_organization"))
                .then()
                .log().all()
                .extract().response();
    ...
    public void tc02_UpdateDocuments() throws IOException {
        ...
        Response responseFileE = given()
                ...
                .multiPart("file", signatureTxt, "text/plain")
                .log().all()
                .post(PropertyUtils.readProperty("onboardSignature01ConsentUrl_organization"))
                .then()
                .log().all()
                .extract().response();
