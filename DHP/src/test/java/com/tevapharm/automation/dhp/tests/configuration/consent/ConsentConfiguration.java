...
public class ConsentConfiguration extends PartnerApiTestBase {

    private String partnerID = "";

    @Test(priority = 1, testName = "Onboard documents to specific partner")
    @Traceability(URS = {"1590"})
    public void tc01_checkAccessTokenCreated() throws IOException, InterruptedException {
        ...
        Response responseFileD = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardMarketing02ConsentUrl"))
                .then()
                .log().all()
                .extract().response();
        ...
        Response responseFileF = given()
                ...
                .log().all()
                .post(PropertyUtils.readProperty("onboardPac02ConsentUrl"))
                .then()
                .log().all()
                .extract().response();
    ...
    public static class ConsentsResponse {
        ...
        public List<OnboardPartnerConsentPositiveTest.ConsentsResponse.Consent> consents;

        public static class Consent {
            public String version;
            public List<OnboardPartnerConsentPositiveTest.ConsentsResponse.Consent.Locales> locales;
