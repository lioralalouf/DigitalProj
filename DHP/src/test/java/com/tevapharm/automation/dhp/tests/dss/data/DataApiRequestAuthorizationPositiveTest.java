...
public class DataApiRequestAuthorizationPositiveTest extends PartnerApiTestBase {
    ...
    @Test(priority = 1, testName = "Positive E2E - authorization for data request with valid IP Address Octal", dataProvider = "getValidIPOctals", dataProviderClass = DataProviders.class)
    @Traceability(FS = {"1634"})
    public void tc01_e2eRequestAuthorization(String ip) throws IOException, ParseException, InterruptedException, org.json.simple.parser.ParseException {
        ...
        extentTest.info("Generate new API key with valid read inhaler scope and valid different IP octal");
        ...
        Profile profile1 = ProfileGenerator.getProfile();
        ...
        MobileApplication mobileApplication1 = MobileApplicationGenerator.getATTTE();
        ...
        MedicalDevice medicalDevice1 = MedicalDeviceGenerator.getProAir();
