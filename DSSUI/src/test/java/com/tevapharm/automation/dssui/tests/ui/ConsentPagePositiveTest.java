...
public class ConsentPagePositiveTest extends UiBaseTest {
    ...
    public void tc03_checkPersonExists() throws IOException {
        ...
        TevaAssert.assertTrue(extentTest, cp.checkPersonExist(PropertyUtils.readProperty("guardianName"), PropertyUtils.readProperty("guardianDob")), "");
        TevaAssert.assertTrue(extentTest, cp.checkPersonExist(PropertyUtils.readProperty("dependent3Name"), PropertyUtils.readProperty("dependent3Dob")), "");
        TevaAssert.assertTrue(extentTest, cp.checkPersonExist(PropertyUtils.readProperty("dependent4Name"), PropertyUtils.readProperty("dependent4Dob")), "");
        TevaAssert.assertFalse(extentTest, cp.checkPersonExistByName(PropertyUtils.readProperty("dependent1Name")), "");
        TevaAssert.assertFalse(extentTest, cp.checkPersonExistByName(PropertyUtils.readProperty("dependent2Name")), "");
    }
