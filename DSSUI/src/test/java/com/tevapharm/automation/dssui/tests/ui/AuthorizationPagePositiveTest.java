...
import com.tevapharm.automation.dssui.pageObjects.AuthorizationPage;
...
public class AuthorizationPagePositiveTest extends UiBaseTest {
    ...
    public void tc01_checkAccessTokenCreated() throws IOException, ParseException, InterruptedException, org.json.simple.parser.ParseException {
    ...
    public void tc03_uploadDocuments() throws IOException {
        ...
        TevaAssert.assertEquals(extentTest,terms, PropertyUtils.readProperty("termsOfUseText"), "terms of use document version is correct");
        takeScreenshot(extentTest);
        String privacy = ap.getPrivacyNoticeText();
        TevaAssert.assertEquals(extentTest,privacy, PropertyUtils.readProperty("privacyNoticeText"), "privacy notice version is correct");
        takeScreenshot(extentTest);
        String hipaa = ap.getHipaaTxt();
        TevaAssert.assertEquals(extentTest,hipaa, PropertyUtils.readProperty("hipaaText"), "hipaa document version is correct");
        takeScreenshot(extentTest);
    }
